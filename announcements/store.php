...
/*
    if ($_REQUEST['hub_challenge']){
        ...
        header("Location: https://chukwumaokere.com/twitch/announcements/enroll.php?client_id=$client_id&app_access_token=$app_access_token&access_token=$access_token&user_id=$user_id");
